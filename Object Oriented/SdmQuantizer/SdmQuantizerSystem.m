classdef SdmQuantizerSystem < matlab.System
    ...
    properties (Nontunable)
        % roundHalfTo - Round half to
        roundHalfTo@double scalar
    end
    ...
    methods (Access = protected)
        ...
        function y = stepImpl(this, u)
            y = this.quantize(u);
            this.simSampleNum = this.simSampleNum + single(1);
        end
